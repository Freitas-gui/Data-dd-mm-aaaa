public class Aluno {
	...
	public double getMedia() {
  	...
  	private double calculaMedia(int _limite)throws Exception {
        	this.calculaMedia();
        	if(this.media > limiteSup)
              	this.media = limiteSup;
        	return this.media;
  	}
  	...
  	public void ultrapassaNota() {
  		if (this.nota1>limiteSup)
  			System.out.println("Nota 1 ultrapassou o limite");
  		if(this.nota2>limiteSup)
  			System.out.println("Nota 2 ultrapassou o limite");
  	}
